...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002118814240').split()]
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002011612381')
...
premium = environ.get('PREMIUM_LOGS', '-1002029241634')
PREMIUM_LOGS = int(premium) if premium and id_pattern.search(premium) else None

IMPORT_JK_SITE = environ.get('IMPORT_JK_SITE', '0')
IMPORT_JK_API = environ.get('IMPORT_JK_API', '0')
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001940169411")
